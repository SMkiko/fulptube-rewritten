    ...
    <head>
        ...
        <style>
            #channelbg {
                ...
                right: 0;
                top: 229px;
                <?php if(isset($_SESSION['siteusername']) && $_SESSION['siteusername'] != $_user['username']) echo "top: 59px;"; ?>
                left: -46px;
                z-index: -1;
    ...
    <body>
        ...
        <div class="www-core-container" style="height: 2994px;">
            <div class="user-header-top">
                <img src="/dynamic/pfp/<?php echo $_user['pfp']; ?>"><h1><?php echo htmlspecialchars($_user['username']); ?></h1>
